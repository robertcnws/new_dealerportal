...
API_ROOT_DATA_URL = env('API_ROOT_DATA_URL')
API_MAIN_DATA_URL = env('API_MAIN_DATA_URL')
API_USER_DATA_URL = env('API_USER_DATA_URL')
API_MAIN_DATA_TOKEN = env('API_MAIN_DATA_TOKEN')